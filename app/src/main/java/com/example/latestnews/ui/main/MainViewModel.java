...
//        RetrofitClient.getClient().getResponseWithParameters("eg", "health").enqueue(new Callback<NewsResponse>() {
//            @Override
//            public void onResponse(Call<NewsResponse> call, Response<NewsResponse> response) {
//                if (response.isSuccessful()) {
//                    listMutableLiveData.postValue(response.body().getArticles());
...
//        RetrofitClient.getClient().getResponseWithParameters("eg", "science").enqueue(new Callback<NewsResponse>() {
//            @Override
//            public void onResponse(Call<NewsResponse> call, Response<NewsResponse> response) {
//                if (response.isSuccessful()) {
//                    listMutableLiveData.postValue(response.body().getArticles());
...
//        RetrofitClient.getClient().getResponseWithParameters("eg", "sports").enqueue(new Callback<NewsResponse>() {
//            @Override
//            public void onResponse(Call<NewsResponse> call, Response<NewsResponse> response) {
//                if (response.isSuccessful()) {
//                    listMutableLiveData.postValue(response.body().getArticles());
...
//        RetrofitClient.getClient().getResponseWithParameters("eg", "technology").enqueue(new Callback<NewsResponse>() {
//            @Override
//            public void onResponse(Call<NewsResponse> call, Response<NewsResponse> response) {
//                if (response.isSuccessful()) {
//                    listMutableLiveData.postValue(response.body().getArticles());
